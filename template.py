...
list_of_files = [
    ...
    f"src/{project_name}/components/data_validation.py.py",
    ...
    f"src/{project_name}/pipeline/stage03_data_transformation.py",
    f"src/{project_name}/pipeline/stage04_model_trainer.py",
    ...
    "research/03_data_tansformation.ipynb",
